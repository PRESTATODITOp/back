...
var insertReserva = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(req, res) {
    var nombre_insumo, tipo_insumo, caracteristicas, cantidad, jornada, fecha_res, hora_res, estado, tiempo_requerido, id_usuario, result;
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 10;
          _context3.next = 13;
          return _db.pool.query("CALL spInsertReserva('".concat(nombre_insumo, "','").concat(tipo_insumo, "','").concat(caracteristicas, "','").concat(cantidad, "','").concat(jornada, "','").concat(fecha_res, "','").concat(hora_res, "','").concat(estado, "','").concat(tiempo_requerido, "','").concat(id_usuario, "');"));
        case 13:
...
var updateReserva = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var id, nombre_insumo, tipo_insumo, caracteristicas, cantidad, jornada, fecha_res, hora_res, estado, tiempo_requerido, id_usuario, result;
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 11;
          _context5.next = 14;
          return _db.pool.query("CALL spUpdateReserva(".concat(id, ",'").concat(nombre_insumo, "','").concat(tipo_insumo, "','").concat(caracteristicas, "','").concat(cantidad, "','").concat(jornada, "','").concat(fecha_res, "','").concat(hora_res, "','").concat(estado, "','").concat(tiempo_requerido, "','").concat(id_usuario, "');"));
        case 14:
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.prev = 2;
          _context6.next = 5;
          return _db.pool.query("CALL spUpdateEstado(".concat(id, ",'").concat(estado, "');"));
        case 5:
